...
class NodeConfigHandler:
    ...
    def create_node_config(self, config, client_ip):
        ...
        node_config_to_write = {
            ...
            "right_neighbor": self.node['right_neighbor'],
            "left_neighbor": self.node['left_neighbor'],
            "child_ip": self.node['child_ip'],
            "parent_ip": self.node['parent_ip'],
            "right_neighbor_ip": self.node['right_neighbor_ip'],
            "left_neighbor_ip": self.node['left_neighbor_ip'],
